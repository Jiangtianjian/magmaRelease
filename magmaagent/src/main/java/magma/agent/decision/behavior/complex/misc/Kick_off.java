 ...
 */
public class Kick_off extends RoboCupComplexBehavior
{
	...
	public Kick_off(IThoughtModel thoughtModel, BehaviorMap behaviors, List<String> availableKicks)
	{
		this(IBehaviorConstants.KICK_OFF, thoughtModel, behaviors, availableKicks);
	}

	public Kick_off(String name, IThoughtModel thoughtModel, BehaviorMap behaviors, List<String> availableKicks)
	{
