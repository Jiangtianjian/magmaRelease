...
public class TrainingKick8MPositionProfiler extends KickPositionProfilerBase
{
	public TrainingKick8MPositionProfiler(IRoboCupThoughtModel thoughtModel)
	{
		super(thoughtModel);
	}
